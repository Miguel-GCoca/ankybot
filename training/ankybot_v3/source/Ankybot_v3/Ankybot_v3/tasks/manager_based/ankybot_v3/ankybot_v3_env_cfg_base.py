...
class RewardsCfg:
    ...
    # split of foot_clearance_reward, carried over from the Rec2 rear-leg-clearance investigation.
    # RewardManager.compute() skips any term with weight exactly 0.0 entirely (never calls the
    ...
    # front feet had no ceiling at all -- playback showed all four feet sitting near the 90 deg
    # hard limit persistently, not just rear. Mirrors rear_foot_max_angle exactly.
