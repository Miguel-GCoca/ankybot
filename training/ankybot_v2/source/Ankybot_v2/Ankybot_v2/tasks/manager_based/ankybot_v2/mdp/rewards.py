...
"""This sub-module contains the reward functions that can be used for Ankybot V2 locomotion task.
...
def foot_slip_penalty(
    ...
    foot_planar_velocity = torch.linalg.norm(wp.to_torch(asset.data.body_lin_vel_w)[:, asset_cfg.body_ids, :2], dim=2)
