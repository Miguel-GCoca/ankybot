...
def main(env_cfg: ManagerBasedRLEnvCfg | DirectRLEnvCfg | DirectMARLEnvCfg, agent_cfg: RslRlBaseRunnerCfg):
    ...
    with launch_simulation(env_cfg, args_cli):
        ...
        # specify directory for logging runs. Use run_name directly when provided so sweep folders match table codes.
        log_dir = agent_cfg.run_name if agent_cfg.run_name else datetime.now().strftime("%Y-%m-%d_%H-%M-%S")
